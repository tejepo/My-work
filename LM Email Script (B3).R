...
#Data
my_dat <- read_csv("Labor Market eDatabase Block 3.csv")
#my_dat <- my_dat[-65:-72,] #these cases have no data about jobs


#Tremayne Jackson
#Google API
use_secret_file("~/Desktop/HP/Block 3/Google API/jackson-tremayne-lm.json")
...
#Tyrone Washington
#Google API
use_secret_file("~/Desktop/HP/Block 3/Google API/washington-tyrone-lm.json")
#force the authorization (seems to be necessary to change sender)
gmail_auth(scope = "full")
...
#Leroy King
#Google API
use_secret_file("~/Desktop/HP/Block 3/Google API/king-leroy-lm.json")
#force the authorization (seems to be necessary to change sender)
gmail_auth(scope = "full")
...
#Tao Lee
#Google API
use_secret_file("~/Desktop/HP/Block 3/Google API/lee-tao-lm.json")
#force the authorization (seems to be necessary to change sender)
gmail_auth(scope = "full")
...
#Chang Yang
#Google API
use_secret_file("~/Desktop/HP/Block 3/Google API/yang-chang-lm.json")
#force the authorization (seems to be necessary to change sender)
gmail_auth(scope = "full")
...
#Zhiyuan Wang
#Google API
use_secret_file("~/Desktop/HP/Block 3/Google API/wang-zhiyuan-lm.json")
#force the authorization (seems to be necessary to change sender)
gmail_auth(scope = "full")
